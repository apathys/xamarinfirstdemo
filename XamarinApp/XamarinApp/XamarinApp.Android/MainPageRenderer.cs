...
[assembly: ExportRenderer(typeof(MainAppPage), typeof(MainAppPageRenderer))]
namespace XamarinApp.Droid
{
    public class MainAppPageRenderer : VisualElementRenderer<MainAppPage>, IOnTabClickListener
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<MainAppPage> e)
        {
        ...
        private void InitializeElement(MainAppPage element)
        {
        ...
        /// </summary>
        /// <param name="element"></param>
        private void ClearElement(MainAppPage element)
        {
            if (_currentPage != null)
            {
        ...
        /// <param name="element"></param>
        /// <returns></returns>
        private BottomBar CreateBottomBar(MainAppPage element)
        {
            ...
            //bar.SetActiveTabColor(Color.White);  TODO 
            //bar.ItemContainer.
